  ...
  <div class="app-container">
    ...
    <el-dialog :title="formTitle[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <el-form ref="dataForm" :rules="rules" :model="formData" label-width="100px">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item v-if="cronVisible" :label="$t('table.cronExpression')" prop="cronExpression">
              <el-popover v-model="cronPopover">
                <el-input slot="reference" v-model="formData.cronExpression" @click="cronPopover=true" />
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item v-if="cronVisible" :label="$t('table.misfirePolicy')" prop="misfirePolicy">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item v-if="simpleVisible" :label="$t('table.repeatInterval')" prop="repeatInterval">
              <el-input v-model="formData.repeatInterval" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item v-if="simpleVisible" :label="$t('table.repeatCount')" prop="repeatCount">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="simpleVisible" :label="$t('table.startTime')" prop="startTime">
              <el-date-picker
          ...
          <el-col :span="12">
            <el-form-item v-if="simpleVisible" :label="$t('table.endTime')" prop="endTime">
              <el-date-picker
